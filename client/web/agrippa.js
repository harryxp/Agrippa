...
(function(exports) {
  ...
  var addShortcutLabels = function (htmlTag) {
      return function (nodes) {
          ...
          throw new Error("Failed pattern match at Agrippa.Utils (line 32, column 3 - line 39, column 25): " + [ v.constructor.name ]);
      };
  };
  ...
  var lookupConfigVal = function (key) {
      return function (config) {
          return Control_Bind.bind(Data_Either.bindEither)(Agrippa_Utils.mToE("Config Error: expect JSON object.")(Data_Argonaut_Core.toObject(config)))(function (v) {
              return Agrippa_Utils.mToE("Config Error: expect JSON object with a(n) '" + (key + "' key."))(Foreign_Object.lookup(key)(v));
          });
      };
  };
...
(function(exports) {
          ...
          return function (cellData2) {
              return function (tableElement) {
                  ...
                  return function __do() {
                      ...
                      createTaskTableCell(cellData1)(v)();
                      createTaskTableCell(cellData2)(v)();
  ...
  var createTaskTableData = function (config) {
      return function (tableElement) {
          return function (keywordFilter) {
              var getKeywordsToTaskNames = Control_Bind.bind(Data_Either.bindEither)(Agrippa_Config.getObjectVal("tasks")(config))(function (v) {
                  return Data_Traversable.traverse(Foreign_Object.traversableObject)(Data_Either.applicativeEither)(Agrippa_Config.getStringVal("name"))(Foreign_Object.filterKeys(keywordFilter)(v));
              });
              if (getKeywordsToTaskNames instanceof Data_Either.Left) {
                  return Agrippa_Utils.displayOutputText(getKeywordsToTaskNames.value0);
              };
              if (getKeywordsToTaskNames instanceof Data_Either.Right) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function (tp) {
                      return createTaskTableRow("<td>")(Data_Tuple.fst(tp) + "<SPACE>")(Data_Tuple.snd(tp))(tableElement);
                  })(Foreign_Object.toAscUnfoldable(Data_Unfoldable.unfoldableArray)(getKeywordsToTaskNames.value0));
              };
              throw new Error("Failed pattern match at Agrippa.Help (line 39, column 3 - line 43, column 72): " + [ getKeywordsToTaskNames.constructor.name ]);
          };
      };
  };
  var createHelp = function (config) {
      ...
      return function __do() {
          ...
          createTaskTableRow("<th>")("Keyword (followed by <SPACE>)")("Task")(v)();
          createTaskTableData(config)(v)(Data_Function["const"](true))();
  ...
  exports["createTaskTableData"] = createTaskTableData;
...
(function(exports) {
  ...
  "use strict";
  var Agrippa_Config = PS["Agrippa.Config"];
  var Agrippa_Plugins_PluginType = PS["Agrippa.Plugins.PluginType"];
  var Agrippa_Utils = PS["Agrippa.Utils"];
  var Control_Alt = PS["Control.Alt"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
          ...
          return function (v1) {
              return function (v2) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Agrippa.Plugins.FileSystem.Commons (line 65, column 3 - line 69, column 71): " + [ v5.constructor.name ]);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var JQuery = PS["JQuery"];
  var Prelude = PS["Prelude"];                 
  var showHelp = function (v) {
      return function (v1) {
          return function (v2) {
              var affHandler = function (v3) {
                  return function (v4) {
                      if (v4 instanceof Data_Either.Right && (v4.value0.status === 200 && v4.value0.body instanceof Data_Either.Right)) {
                          return Agrippa_Help.createTaskTableData(v4.value0.body.value0)(v3)(Data_Function["const"](true));
                      };
                      return Agrippa_Utils.displayOutputText("Failed to retrieve config from server.");
                  };
              };
              return function __do() {
                  var v3 = JQuery.create("<table>")();
                  Agrippa_Help.createTaskTableRow("<th>")("Keyword (followed by <SPACE>)")("Task")(v3)();
                  Effect_Aff.runAff_(affHandler(v3))(Affjax.get(Affjax_ResponseFormat.json)("/agrippa/config/"))();
  ...
  exports["help"] = help;
})(PS["Agrippa.Plugins.Help"] = PS["Agrippa.Plugins.Help"] || {});
(function(exports) {
    "use strict";
  ...
  var buildEntryUI = function (entry) {
          ...
          return function (entryDiv) {
              return function __do() {
                  ...
                  (function () {
                      ...
                      throw new Error("Failed pattern match at Agrippa.Plugins.KeePass1 (line 107, column 7 - line 109, column 37): " + [ v3.constructor.name ]);
                  })();
                  return v1;
              };
          };
      ...
      var appendPre = function (fieldName) {
          return function (entryDiv) {
              ...
              throw new Error("Failed pattern match at Agrippa.Plugins.KeePass1 (line 114, column 7 - line 119, column 37): " + [ v.constructor.name ]);
          };
      };
...
(function(exports) {
  ...
  var Agrippa_Plugins_Help = PS["Agrippa.Plugins.Help"];
          ...
          return function (timeoutIdRefMb) {
              return function __do() {
                  ...
                  var taskKeyTimeout = (function () {
                      ...
                      throw new Error("Failed pattern match at Agrippa.Main (line 141, column 24 - line 143, column 38): " + [ taskKeyTimeoutE.constructor.name ]);
                  })();
  ...
  var displayTaskCandidates = function (config) {
      return function (wholeInput) {
          return function (taskPromptTail) {
              return function __do() {
                  var v = JQuery.create("<table>")();
                  Agrippa_Help.createTaskTableRow("<th>")("Keyword (followed by <SPACE>)")("Task")(v)();
                  Agrippa_Help.createTaskTableData(config)(v)(function (key) {
                      return Data_String_Utils.startsWith(wholeInput)(key);
                  })();
      ...
      return function (keyCodeMb) {
          return function (wholeInput) {
              return function (timeoutIdRefMb) {
                  ...
                  var execTaskIfEnter = function (v) {
                      return function (v1) {
                          if (v1 === 13) {
                              return execTask(v)(13)(timeoutIdRefMb);
                          };
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                      };
                  };
                  if (findDefaultTask instanceof Data_Maybe.Just) {
                      return function __do() {
                          displayTaskCandidates(config)(wholeInput)("  Press <ENTER> to use the default task - " + (findDefaultTask.value0.value0.name + "."))();
                          return Data_Maybe["maybe'"](Control_Applicative.pure(Effect.applicativeEffect))(execTaskIfEnter(findDefaultTask.value0))(keyCodeMb)();
                      };
                  };
                  if (findDefaultTask instanceof Data_Maybe.Nothing) {
                      return displayTaskCandidates(config)(wholeInput)("");
                  };
                  throw new Error("Failed pattern match at Agrippa.Main (line 101, column 3 - line 106, column 3): " + [ findDefaultTask.constructor.name ]);
              };
          };
      };
  };
          ...
          return function (wholeInput) {
              return function (timeoutIdRefMb) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Agrippa.Main (line 82, column 3 - line 86, column 110): " + [ v.constructor.name ]);
                  };
              };
          };
      };
                  ...
                  return function (inputField) {
                      return function __do() {
                          ...
                          if (v2 instanceof Data_Either.Right) {
                              ...
                              var $81 = v3 === v2.value0 && v !== 13;
                              if ($81) {
                                  return Data_Unit.unit;
                              };
                              return dispatchToTask(config)(v)(v2.value0)(timeoutIdRefMb)();
                          };
                          throw new Error("Failed pattern match at Agrippa.Main (line 61, column 3 - line 70, column 69): " + [ v2.constructor.name ]);
                      };
                  };
              };
          };
